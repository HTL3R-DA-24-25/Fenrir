...
% diese Liste an Abkürzungen war bereits in der Vorlage, manches davon nützlich daher lass ich es hier mal liegen
% ABER: in der Zukunft wenn das Buch basically fertig ist alle ungenutzten Abkürzungen rauslöschen!!
\newacr{ACL}{ACL}{ACLs}{Access Control List}{Access Control Lists}
\newacr{AD}{AD}{ADs}{Active Directory}{Active Directories}
...
\newacr{SPS}{SPS}{SPS}{Speicherprogrammierbare Steuerung}{Speicherprogrammierbare Steurungen}
\newacr{DMZ}{DMZ}{DMZs}{Demilitarisierte Zone}{Demilitarisierte Zonen}
\newacr{CAN}{CAN}{CANs}{Controller Area Network}{Controller Area Networks}
\newacr{I2C}{I$^{2}$C}{I$^{2}$C}{Inter-Integrated Circuit}{Inter-Integrated Circuits}
\newacr{SPI}{SPI}{SPIs}{Serial Peripheral Interface}{Serial Peripheral Interfaces}
\newacr{IT}{IT}{ITs}{Informational Technology}{Informational Technologies}
\newacr{OT}{OT}{OTs}{Operational Technology}{Operational Technologies}
\newacr{IO}{IO}{IOs}{Input/Output}{Inputs/Outputs}
\newacr{HMI}{HMI}{HMIs}{Human Machine Interface}{Human Machine Interfaces}
\newacr{AWL}{AWL}{Anweisungsliste}{Anweisungsliste}
\newacr{ST}{ST}{Strukturierter Text}{Strukturierter Text}
\newacr{KOP}{KOP}{Kontaktplan}{Kontaktplan}
\newacr{FUP}{FUP}{Funktionsplan}{Funktionsplan}
\newacr{AS}{AS}{Ablaufsprache}{Ablaufsprache}
\newacr{SCADA}{SCADA}{SCADA}{Supervisory Control and Data Acquisition}{Supervisory Control and Data Acquisition} % NIX "SCADAs" --> "SCADA-Systeme" :)
\newacr{DCS}{DCS}{DCSs}{Distributed Control System}{Distributed Control Systems}
\newacr{Profibus}{Profibus}{Profibus}{Process Field Bus}{Process Field Bus}
\newacr{GUI}{GUI}{GUIs}{Graphical User Interface}{Graphical User Interfaces}
\newacr{VM}{VM}{VMs}{Virtuelle Maschine}{Virtuelle Maschinen}
\newacr{ICS}{ICS}{ICSs}{Industrial Control System}{Industrial Control Systems}
\newacr{NIS}{NIS}{NIS}{Netz- und Informationssystem­sicherheit}{Netz- und Informationssystem­sicherheit}

% Beispiel(e) aus der Vorlage:
...
\newgls{Purdue-Modell}{Purdue-Modell}{Purdue-Modelle}{Das Purdue-Modell (auch bekannt als "'Purdue Enterprise Reference Architecture"', kurz PERA), ähnlich zum OSI-Schichtenmodell, dient zur Einteilung bzw. Segmentierung eines \acrshort{ics}-Netzwerks. Je niedriger die Ebene, desto kritischer sind die Prozesskontrollsysteme, und desto strenger sollten die Sicherheitsmaßnahmen sein, um auf diese zugreifen zu können. Die Komponenten der niedrigeren Ebenen werden jeweils von Systemen auf höhergelegenen Ebenen angesteuert. Level 0 bis 3 gehören zur \acrshort{ot}, 4 bis 5 sind Teil der \acrshort{it}. Es gibt nicht nur ganzzahlige Ebenen, denn im Falle einer \acrshort{dmz} zwischen beispielsweise den Ebenen 2 und 3 wird diese als Ebene 2.5 gekennzeichnet.}

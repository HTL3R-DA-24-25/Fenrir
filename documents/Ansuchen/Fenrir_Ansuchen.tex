...
\newcommand{\kopfTXT}{\sffamily{\textbf{\normalsize{HÖHERE TECHNISCHE BUNDESLEHRANSTALT Wien 3 \\Rennweg}}
...
\begin{enumerate}[start=1,label={\bfseries Ziel-H \arabic*},leftmargin=*]
...
\item{\underline{Jump Server Aufsetzung}}\\
...
\begin{enumerate}[start=1,label={\bfseries Ziel-O \arabic*},leftmargin=*]
...
\begin{enumerate}[start=1,label={\bfseries Ziel-N \arabic*},leftmargin=*]

...
Einige Bestandteile die eingeplant waren für die OT gibt es in einer Ausführung wie von uns gewünscht nicht zu kaufen. Weshalb sich Gabriel Vogler einen 3D-Drucker zugelegt hat. Der Drucker kam jedoch mit einem Softwarefehler, weshalb er sich nicht gescheit einstellen hat lassen von der Höhe und sich im Anschluss auch leicht selbst beschädigt hat. Zahlreiche Versuche den Drucker zum Laufen zu bringen kostete viel Zeit was insgesamt um die 8 Stunden waren. Er musste anschließend eingeschickt werden und es wurde bereits ein zuverlässigeres moderneres Modell bestellt was die nächsten Tage eintreffen sollte.
...
Der Prototyp hat zurzeit zwei Wassertanks, wobei einer befüllt wird und der andere nicht. Im ersten befindet sich ein Füllstandssensor und sobald der Tank voll ist schaltet die SPS die Pumpe ein, so lange bis der erste Tank leer ist und der andere voll. Außerdem haben beide Wassertanks einen Temparatursensor der auch mittels der SPS ausgelesen werden kann.
...
Es muss auch eine dedizierte VPN-Verbindung zum Kollegen Vogler nach Hause erstellt werden, um jederzeit auf die bestehende OT-Gerätschaft zugreifen zu können, als auch diese später mit virtuellen Maschinen auf der UCS verbinden zu können.

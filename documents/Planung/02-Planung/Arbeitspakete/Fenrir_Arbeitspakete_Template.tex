...
{hyperref}
\hypersetup{pdftitle={Fenrir Arbeitspaketdefinition},
	pdfauthor={David Koch & sein Python-Skript},
	pdfsubject={DA},
	pdfkeywords={5CN, ITP}}
...
{\sffamily{\textbf{\LARGE{\textcolor{orange}{Arbeitspaketdefinition}}}}}\\
...
{\smaller
	...
	v1.0 & 24.09.2024 & David Koch & Erstellung der LaTeX-Template für Befüllung mittels Python-Skript \\
	v1.1 & - & Automatisiert (Jira) & Befüllung der Arbeitspaket-Daten \Bstrut \\
	\hline
	\end{tabularx}
}

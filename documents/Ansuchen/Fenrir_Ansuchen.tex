...
\begin{enumerate}[start=1,label={\bfseries Ziel-H \arabic*}]
...
\begin{enumerate}[start=1,label={\bfseries Ziel-O \arabic*}]
...
\begin{enumerate}[start=1,label={\bfseries Ziel-N \arabic*}]

...
\usepackage[unicode=true,
 ...
 {hyperref}
\hypersetup{pdftitle={Fenrir},
 pdfauthor={David Koch, Bastian Uhlig, Julian Burger, Gabriel Vogler},
 pdfsubject={Diplomarbeit},
 pdfkeywords={Diplomarbeit, Fenrir, 2024/25, HTL3R IT NWT}}
...
\vspace{15mm}
\textbf{\large{}Fenrir}\\
\textbf{\large{}Zum Schutz von OT-Netzwerken}\\
...
\textbf{\large{}Julian Burger} && Christian Schöndorfer \\
\textbf{\large{}David Koch} && Christian Schöndorfer \\
\textbf{\large{}Bastian Uhlig} && Clemens Kussbach \\
\textbf{\large{}Gabriel Vogler} && Clemens Kussbach \\
\end{tabular}
}

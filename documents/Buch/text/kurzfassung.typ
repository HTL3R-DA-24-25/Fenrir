...
Der IT-Bereich besteht aus virtualisierten Windows- bzw. Linux-Computern, die Teil einer Active-Directory-Domäne sind. Die Windows-Server sind zwei redundate Domain Controller als auch ein Microsoft Exchange Server, welcher als Mail-Server eingesetzt wird. Die Linux-Server dagegen dienen für VPNs und Netzwerküberwachung.
